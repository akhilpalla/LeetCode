<h2><a href="https://leetcode.com/problems/convert-json-string-to-object">2759. Convert JSON String to Object</a></h2><h3>Hard</h3><hr><p>Given a string <code>str</code>, return parsed JSON&nbsp;<code>parsedStr</code>.&nbsp;You may assume the <code>str</code>&nbsp;is a valid JSON string hence it only includes strings, numbers, arrays, objects, booleans, and null. <code>str</code>&nbsp;will not include invisible characters and escape characters.&nbsp;</p>
