<h2><a href="https://leetcode.com/problems/closest-binary-search-tree-value-ii/?envType=weekly-question&envId=2025-07-29">272. Closest Binary Search Tree Value II</a></h2><h3>Hard</h3><hr><p>Given the <code>root</code> of a binary search tree, a <code>target</code> value, and an integer <code>k</code>, return <em>the </em><code>k</code><em> values in the BST that are closest to the</em> <code>target</code>. You may return the answer in <strong>any order</strong>.</p>
